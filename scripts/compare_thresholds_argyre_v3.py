...
output for the Argyre test tiles (t0434, t0435).
...
sets, and produces:
  ...
  - A summary figure: 2 tiles × 4 cols (RGB, uniform map, inverse map,
    pixel-level "what changed" map)
  - A per-class detection-area summary printed to stdout

Outputs:
  reports/v5/fig_v5_argyre_threshold_comparison.png

Usage (no args needed):
    conda run -n crism python scripts/compare_thresholds_argyre_v3.py
"""
...
# Tiles to compare (Argyre MC26)
TILES = ['t0434', 't0435']
PROBS_DIR = '/tmp/v3_argyre'
TILE_DIR = '/Volumes/Mars_GIS/CRISM/MRDR/mc26'
TILE_MRRAL = {
    't0434': f'{TILE_DIR}/t0434_mrral_40s318_0327_4.img',
    't0435': f'{TILE_DIR}/t0435_mrral_40s323_0327_4.img',
}

OUT_PATH = os.path.join(PROJECT_ROOT, 'reports', 'v5',
                        'fig_v5_argyre_threshold_comparison.png')
...
def main():
    ...
    fig.suptitle(
        'v3 denoising classifier — Argyre test tiles\n'
