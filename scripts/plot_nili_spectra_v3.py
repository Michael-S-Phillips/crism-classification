...
v3 (denoising) classifier outputs in the Nili Fossae 4-tile area.

Mirrors plot_nili_spectra.py but reads from the new vector_v3_denoising/
GeoPackages (val_AP-informed inverse-proportional + floor=0.80 thresholds).

Output: reports/v5/fig_v5_nili_spectra_v3_denoising.png

Usage:
    conda run -n crism python scripts/plot_nili_spectra_v3.py
"""
import os
import sys
...
OUT_PATH = os.path.join(PROJ, 'reports', 'v5',
                        'fig_v5_nili_spectra_v3_denoising.png')
...
def main():
    ...
    fig.suptitle(
        ...
        'Nili Fossae 4-tile mosaic; left: raw reflectance, right: ratio vs other (neutral)\n'
