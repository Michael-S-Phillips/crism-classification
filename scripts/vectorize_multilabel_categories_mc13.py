...
Output:      data/vector_mc13_v3_denoising/mc13_v3_denoising_categories.gpkg
Wavelength sidecar:
             data/vector_mc13_v3_denoising/mc13_v3_denoising_wavelengths.json

Usage (no args needed):
    conda run -n crism python scripts/vectorize_multilabel_categories_mc13.py
"""
...
WAVELENGTHS_SIDECAR = os.path.join(PROJ, 'data', 'vector_mc13_v3_denoising',
                                   'mc13_v3_denoising_wavelengths.json')
